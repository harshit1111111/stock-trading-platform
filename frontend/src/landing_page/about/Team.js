...
const team = [
  {
    ...
    role: "Founder & CEO",
    emoji: "👨‍💼",
    bio: "Harshit founded Zerodha in 2010 after a decade as an active trader. His vision: make stock trading free, fair, and fast for every Indian. Under his leadership, Zerodha grew to serve over 1.5 crore clients.",
  ...
  },
  {
    ...
    role: "Co-Founder & CTO",
    emoji: "👩‍💻",
    bio: "Priya leads all technology at Zerodha. A former engineer at Goldman Sachs, she built our in-house trading engine that handles millions of orders per second with 99.9% uptime.",
  ...
  },
  {
    ...
    emoji: "👨‍🔧",
    bio: "Rajeev ensures Zerodha runs like clockwork — from regulatory compliance to back-office operations. He brings 15+ years of experience from SEBI-regulated brokerages.",
    social: ["LinkedIn"],
  },
  {
    name: "Sneha Kulkarni",
    ...
    emoji: "👩‍🎓",
    bio: "Sneha built our 24×5 support team from scratch. She is passionate about investor education and leads Zerodha's free learning initiatives reaching 2 lakh+ students.",
    social: ["LinkedIn", "Twitter"],
  },
];
